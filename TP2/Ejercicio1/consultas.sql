...
SELECT * FROM Barcos WHERE cuota > 500 AND id_socio IN(
  SELECT id_socio FROM Socios
);

-- 5. ¿Qué barcos han salido con destino a 'Mallorca'?
SELECT * FROM Barcos WHERE matricula IN (
